    ...
    <>
      <div className="relative h-full">
        ...
        >
          ...
          >
            I have Completed My{" "}
            <span className="font-bold"> Bachelor Degree </span>from
            PSRGovt.Degree College <br /> Baijnath Himachal Pradesh My
            Specilization in{" "}
          ...
          >
            ...
            creative way. I <br />
            creates <span className="font-bold">web sites</span> for different
            screen sizes.
            <br />
            <br />
            Proven ability to create{" "}
            <span className="font-bold">reusable components </span> for an
            enterprise-level web application.
            <br />
            Passionate about{" "}
            <span className="font-bold">
              technology and building scalable web Application{" "}
            </span>
          </p>
          <h1
            ...
            >
              ...
              <div className="flex flex-col gap-1">
                ...
                >
                  ...
                  <span className="font-bold">mobile apps, web services </span>.
                </p>
              </div>
            </div>
